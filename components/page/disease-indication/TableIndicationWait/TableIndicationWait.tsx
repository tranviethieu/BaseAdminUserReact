...
import styles from './TableIndicationWait.module.scss';
import {TypeData, TypeTableIndicationWait} from './interfaces';
...
function TableIndicationWait({}: TypeTableIndicationWait) {
	...
	useEffect(() => {
		httpRequest({
			...
			http: indicationService.getIndicationWait({
				token: token!,
				...
				<DataWrapper
					...
					noti={
						<Noti
							...
							des='Có vẻ như bạn chưa có phiếu chỉ định nào đang chờ xử lý.'
						/>
					}
				>
...
export default TableIndicationWait;
