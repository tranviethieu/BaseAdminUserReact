...
import styles from './TableAppointmentEnd.module.scss';
...
function TableAppointmentEnd() {
	...
	const {data, isLoading} = useQuery(
		[
			QUERY_APPOINTMENT_SCHEDULE.END,
			accountId,
			keyword,
		...
		() =>
			httpRequest({
				http: manageBooking.getInfoBookingEnd({
					token: token!,
...
export default TableAppointmentEnd;
